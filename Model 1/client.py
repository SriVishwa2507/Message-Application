...
def connect():
    try:
        ...
        messagebox.showerror("Unable to connct to the server", f"Unable to connect to server {HOST} and {PORT}")
        exit(0)
    ...
    if username != '':
        ...
        messagebox.showerror("Invaild username" "Username cannot be empty")
        exit(0)
